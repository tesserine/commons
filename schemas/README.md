...
| [`forge-capability/v1/forge-capability.schema.json`](forge-capability/v1/forge-capability.schema.json) | [`FORGE-CAPABILITY.md`](../FORGE-CAPABILITY.md) | ADR-0005 layout: major version in the directory (`v1/`), full semver (currently `1.2.0`) in prose header and schema description | `groundwork` ([`schemas/forge-capability/v1/forge-capability.schema.json`](https://github.com/tesserine/groundwork/blob/main/schemas/forge-capability/v1/forge-capability.schema.json), provenance-marked, coherence-tested) |
