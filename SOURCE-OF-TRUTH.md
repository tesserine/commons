...
| Intent artifact | current: [`INTENT.md`](INTENT.md) + [`schemas/intent/v2/`](schemas/intent/v2/); retained v1: [`schemas/intent/v1/INTENT.md`](schemas/intent/v1/INTENT.md) + [`schemas/intent/v1/`](schemas/intent/v1/) | `commons` | methodologies vendor with provenance per [ADR-0005](adr/0005-system-conventions.md); existing v1 consumers remain on retained v1 until they migrate |
| Forge capability contract | current: [`FORGE-CAPABILITY.md`](FORGE-CAPABILITY.md) + [`schemas/forge-capability/v2/`](schemas/forge-capability/v2/); retained v1: [`schemas/forge-capability/v1/`](schemas/forge-capability/v1/); architecture: [ADR-0016](adr/0016-connector-layer-architecture-and-forge-capability.md) + [ADR-0017](adr/0017-forge-work-unit-identity-model.md) | `commons` | `runa`, forge connectors, and methodologies vendor or cite with immutable version provenance; the current capability surface uses neutral work-unit operation names, and provider nouns remain connector-internal projections |
...
| Runtime implementation architecture | [`runa/ARCHITECTURE.md`](https://github.com/tesserine/runa/blob/main/ARCHITECTURE.md) | `runa` | the commons cognitive-state-machine concept is conceptual doctrine, not runa implementation architecture |
...
| Tesserine design system | [`design/README.md`](design/README.md) (door: closure boundary, citation form) + versioned [`design/v1/`](design/v1/) (governing fact in [`SYSTEM.md`](design/v1/SYSTEM.md), member files, worked example) | `commons` | rendering surfaces consume by citation — immutable URL plus full semver per [ADR-0005](adr/0005-system-conventions.md)'s reference discipline — and never re-derive or hand-copy values; first consumers are the Gazette projection and design contracts ([tesserine/gazette#10](https://github.com/tesserine/gazette/issues/10), [#13](https://github.com/tesserine/gazette/issues/13), [#14](https://github.com/tesserine/gazette/issues/14)); the discipline it instantiates is the design-as-substrate row above ([commons#110](https://github.com/tesserine/commons/issues/110)) |
